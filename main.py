...
def on_mouse_motion(event):
    ...
    # Deteksi opai untuk shy (misalnya y antara 100 dan 150)
...
def ask_ai_and_talk(question, as_role="user"):
    def worker():
        ...
        # fungsi memanggil cuaca dari weather.com
        weather_info = None
        ...
        # fungsi untuk menambahkan promt cuaca
        if weather_info:
            full_prompt += f"\n[Catatan: Informasi cuaca lokal saat ini adalah: {weather_info}]\n"
...
x_offset = -780  # geser ke kiri 100 piksel
y_offset = 50  # geser lebih ke bawah (nilai negatif agar makin ke atas)
